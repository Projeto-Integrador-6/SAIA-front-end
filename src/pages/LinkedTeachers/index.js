...
export default function LinkedTeacher() {
  ...
  useEffect(() => {
    document.title = `SAIA - Professores Vinculados a ${nome}`
  ...
  return (
    <Sidebar>
      <PageTitle title={`Professores Vinculados a ${nome}`} backLink="/manager/subjects"/>
        ...
        <form>
          <div className="input-block">
            <Autocomplete
              ...
              noOptionsText={'Não há professores para mostrar'}
